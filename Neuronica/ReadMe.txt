========================================================================
    ACTIVE TEMPLATE LIBRARY : Neuronica Project Overview
========================================================================

AppWizard has created this Neuronica project for you to use as the starting point for
...
Neuronica.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Neuronica.h)
        GUID definitions                                (Neuronica_i.c)
        A type library                                  (Neuronica.tlb)
        Marshaling code                                 (Neuronica_p.c and dlldata.c)

Neuronica.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Neuronica.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Neuronica.pch and a precompiled types file named StdAfx.obj.
...
Neuronicaps.vcxproj
	...
	dlldata.c, Neuronica_i.c and Neuronica_p.c which are required
	to build the proxy/stub DLL.

Neuronicaps.vcxproj.filters
